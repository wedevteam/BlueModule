package com.wedevteam.bluemodule.Servizi;
...
import com.wedevteam.bluemodule.Funzioni.Constants;
import com.wedevteam.bluemodule.R;
...
public class SerialService extends Service implements SerialListener {
    ...
    private void createNotification() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, Constants.NOTIFICATION_CHANNEL)
                .setSmallIcon(R.drawable.immaginebase)
                .setColor(ContextCompat.getColor(getApplicationContext(),R.color.primaryColor))
                .setContentTitle(getResources().getString(R.string.app_name))
                .setContentText(socket != null ? "Connesso a "+socket.getName() : "Servizio di Background")
